...
#ifndef _TemplatesListItem_H
#define _TemplatesListItem_H
...
/* Forward declaration of the class Templates::ListItem */
#ifndef _TemplatesListItem_
  EW_DECLARE_CLASS( TemplatesListItem )
#define _TemplatesListItem_
#endif


/* Deklaration of class : 'Templates::ListItem' */
EW_DEFINE_FIELDS( TemplatesListItem, CoreGroup )
EW_END_OF_FIELDS( TemplatesListItem )

/* Virtual Method Table (VMT) for the class : 'Templates::ListItem' */
EW_DEFINE_METHODS( TemplatesListItem, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( TemplatesListItem )

#ifdef __cplusplus
  }
#endif

#endif /* _TemplatesListItem_H */
