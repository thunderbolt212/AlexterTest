...
#ifndef _TemplatesList_H
#define _TemplatesList_H
...
/* Forward declaration of the class Templates::List */
#ifndef _TemplatesList_
  EW_DECLARE_CLASS( TemplatesList )
#define _TemplatesList_
#endif


/* Deklaration of class : 'Templates::List' */
EW_DEFINE_FIELDS( TemplatesList, CoreGroup )
EW_END_OF_FIELDS( TemplatesList )

/* Virtual Method Table (VMT) for the class : 'Templates::List' */
EW_DEFINE_METHODS( TemplatesList, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( TemplatesList )

#ifdef __cplusplus
  }
#endif

#endif /* _TemplatesList_H */
