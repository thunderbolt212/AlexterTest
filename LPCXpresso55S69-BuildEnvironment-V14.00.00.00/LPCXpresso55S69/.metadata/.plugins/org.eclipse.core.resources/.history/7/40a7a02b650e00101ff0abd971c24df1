...
unsigned char ScratchPad[ EW_SCRATCHPAD_WIDTH * EW_SCRATCHPAD_HEIGHT * EW_FRAME_BUFFER_DEPTH ];
...
EW_MEM_SECTION( .bss ) unsigned short TransferBuffer[ EW_SCRATCHPAD_WIDTH * EW_SCRATCHPAD_HEIGHT ];
